...
[**Watch the Demonstration Video Here**](https://youtu.be/9IIQfb88t9U)
...
A short **2-3 minute video** demonstrates the functionalities of the Shiny App, highlighting its interactive features and how it supports exploratory data analysis. [**Watch the Demonstration Video Here**](https://youtu.be/9IIQfb88t9U)

The video includes a walkthrough of the app's interface, showcasing how to navigate between tabs, interact with plots, and interpret the results effectively.
